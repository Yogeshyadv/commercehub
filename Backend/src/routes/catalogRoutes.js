...
const { createCatalog, getCatalogs, getCatalog, getPublicCatalog, updateCatalog, deleteCatalog, addProducts, removeProduct, uploadCoverImage } = require('../controllers/catalogController');
