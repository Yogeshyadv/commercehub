...
const { createCatalog, getCatalogs, getCatalog, getPublicCatalog, updateCatalog, deleteCatalog, addProducts, removeProduct } = require('../controllers/catalogController');
