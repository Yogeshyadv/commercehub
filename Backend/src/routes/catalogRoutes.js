...
const { createCatalog, getCatalogs, getCatalog, getPublicCatalog, updateCatalog, deleteCatalog, addProducts, removeProduct, uploadCoverImage, syncProducts, trackEvent, getCatalogAnalytics } = require('../controllers/catalogController');
...
router.post('/public/:shareableLink/track', trackEvent);
...
router.get('/:id/analytics', authorize('vendor', 'vendor_staff', 'super_admin'), getCatalogAnalytics);
