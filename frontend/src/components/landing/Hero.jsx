...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-emerald-50/30 to-white pt-24 pb-20">
      {/* Decorative elements */}
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-left">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-gray-900 mb-6 leading-tight">
              Transform Your B2B
              <span className="block bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">E-Commerce Business</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                to="/register"
                className="group inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-emerald-600 to-teal-600 text-white text-lg font-semibold rounded-xl hover:from-emerald-700 hover:to-teal-700 transition-all duration-200 shadow-xl shadow-emerald-500/25"
              >
                Get Started Free
              ...
              <Link
                to="/store"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-gray-700 text-lg font-semibold rounded-xl border-2 border-gray-200 hover:border-emerald-300 hover:text-emerald-600 transition-all duration-200"
              >
                View Demo Store
              </Link>
            </div>
            ...
            <div className="mt-12 pt-8 border-t border-gray-200">
              <div className="grid grid-cols-3 gap-8">
                <div>
                  <div className="text-4xl font-bold bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">1000+</div>
                ...
                <div>
                  <div className="text-4xl font-bold bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">₹10Cr+</div>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-10 -right-10 w-72 bg-white rounded-2xl shadow-2xl p-5 border border-gray-200 animate-float animation-delay-2000">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-sm text-emerald-600 font-bold px-2 py-1 bg-emerald-50 rounded-lg">+24%</span>
                </div>
                <div className="h-20 flex items-end gap-1.5">
                  {[40, 65, 45, 80, 60, 95, 75].map((height, i) => (
                    <div key={i} className="flex-1 bg-gradient-to-t from-emerald-600 to-teal-500 rounded-t-lg" style={{ height: `${height}%` }}></div>
                  ))}
                </div>
              </div>
              ...
              <div className="relative bg-white rounded-3xl shadow-2xl border border-gray-200 overflow-hidden">
                <div className="bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-600 h-36 p-6">
