      ...
      <div className="min-h-screen w-full bg-gradient-to-br from-white via-[#E8FFF3]/30 to-white flex items-center justify-center p-4">
        <div className="w-full max-w-md bg-white border border-gray-100 rounded-3xl shadow-xl p-8 text-center animate-in zoom-in-95 duration-500">
          <div className="w-20 h-20 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-6">
            <CheckCircleIcon className="w-10 h-10 text-[#DC2626]" />
          </div>
          ...
          <Link
            to="/login"
            className="w-full bg-gradient-to-r from-[#DC2626] to-[#1DB954] hover:from-[#128C7E] hover:to-[#DC2626] text-white py-3.5 px-4 rounded-xl font-bold shadow-lg shadow-[#DC2626]/20 transition-all duration-300 flex items-center justify-center gap-2"
          >
            Go to Login
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-white via-[#E8FFF3]/30 to-white overflow-hidden relative flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 w-full max-w-md animate-in slide-in-from-bottom-5 fade-in duration-500">
        ...
        <div className="bg-white/80 backdrop-blur-2xl border border-white/60 rounded-3xl shadow-[0_8px_32px_0_rgba(220,38,38,0.12),0_2px_8px_0_rgba(0,0,0,0.04)] p-8 sm:p-10">
          <div className="text-center mb-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-4">
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-400 group-focus-within:text-[#DC2626] transition-colors">
                  <LockIcon className="h-5 w-5" />
                </div>
                <input
                  type={showPassword ? 'text' : 'password'}
                  required
                  className="block w-full pl-11 pr-12 py-3.5 bg-gray-50/50 border border-gray-200 rounded-xl text-gray-900 text-sm focus:ring-2 focus:ring-[#DC2626]/20 focus:border-[#DC2626] focus:bg-white transition-all shadow-sm outline-none"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full relative group overflow-hidden bg-gradient-to-r from-[#DC2626] to-[#1DB954] hover:from-[#128C7E] hover:to-[#DC2626] text-white py-3.5 px-4 rounded-xl font-bold text-sm shadow-lg shadow-[#DC2626]/30 transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed mt-2"
            >
